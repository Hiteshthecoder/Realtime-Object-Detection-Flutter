...
abstract class BaseStateful<T extends StatefulWidget, E extends BaseViewModel> extends State<T>
  ...
  Widget build(BuildContext context) {
    super.build(context);
    return ChangeNotifierProvider.value(value: viewModel, child: buildPageWidget(context));
  }
