...
import 'package:object_detect/widgets/aperture/aperture_leaf_painter.dart';
...
class _ApertureLeafState extends State<ApertureLeaf> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _slide1 = widget.startOpened
        ? Tween(begin: Offset(open1, 0.0), end: Offset(0.0, 0.0)).animate(curvedAnimation)
        : Tween(begin: Offset(0.0, 0.0), end: Offset(open1, 0.0)).animate(curvedAnimation);
    _slide2 = widget.startOpened
        ? Tween(begin: Offset(open2, open1), end: Offset(0.0, 0.0)).animate(curvedAnimation)
        : Tween(begin: Offset(0.0, 0.0), end: Offset(open2, open1)).animate(curvedAnimation);
              ...
              children: <Widget>[
                Positioned(
                    ...
                    child: AnimatedBuilder(
                      builder: (context, child) => SlideTransition(position: _slide1, child: child),
                ...
                Positioned(
                    ...
                    top: centerY - (boxWidth - bladeHeight) - bladeHeight + (apertureBorderWidth / 2),
                    child: AnimatedBuilder(
                      builder: (context, child) => SlideTransition(position: _slide2, child: child),
                      animation: animationController,
                      child: FittedBox(
                        fit: BoxFit.none,
                        child: SizedBox(
                            ...
                            child: CustomPaint(
                              painter: ApertureLeafPainter(
                                  borderWidth: widget.borderWidth, rotationRadians: 0, fillColor: Colors.grey.shade900),
                            )),
                      ),
                    )),
                Positioned(
                    ...
                    child: AnimatedBuilder(
                      builder: (context, child) => SlideTransition(position: _slide3, child: child),
                      animation: animationController,
                      child: FittedBox(
                        fit: BoxFit.none,
                        child: SizedBox(
                ...
                Positioned(
                    ...
                    top: centerY - heightDelta,
                    child: AnimatedBuilder(
                      builder: (context, child) => SlideTransition(position: _slide4, child: child),
                      animation: animationController,
                      child: FittedBox(
                        fit: BoxFit.none,
                        child: SizedBox(
                ...
                Positioned(
                    ...
                    top: centerY + heightDelta + bladeHeight,
                    child: AnimatedBuilder(
                      builder: (context, child) => SlideTransition(position: _slide5, child: child),
                      animation: animationController,
                      child: FittedBox(
                        fit: BoxFit.none,
                        child: SizedBox(
                ...
                Positioned(
                    left: centerX - boxWidth + apertureBorderWidth,
                    top: centerY - heightDelta - bladeHeight + (apertureBorderWidth / 2),
                    child: AnimatedBuilder(
                      builder: (context, child) => SlideTransition(position: _slide6, child: child),
                      animation: animationController,
                      child: FittedBox(
                        fit: BoxFit.none,
                        child: SizedBox(
